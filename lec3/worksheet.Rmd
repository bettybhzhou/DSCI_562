...
<<<<<<< HEAD
- just take average of variance since assume no pattern/trend
=======
...
> No, mF or distribution assumption, just null model
...
<<<<<<< HEAD
> no assumption of MF or distribution
...
<<<<<<< HEAD
    geom_line(data = crab,
              aes(y = q75_glm), colour = "blue", size = 1)
=======
    geom_line(data = crab,
